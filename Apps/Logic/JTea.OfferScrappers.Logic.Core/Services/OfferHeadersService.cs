...
namespace JTea.OfferScrappers.Logic.Core.Services
{
    public class OfferHeadersService : BaseService, IOfferHeadersService
    {
        ...
        {
            if (_processingService.IsRunning) { return GetProcessingStateResult(); }
        ...
        {
            if (_processingService.IsRunning) { return GetProcessingStateResult<bool>(); }
        ...
        {
            if (_processingService.IsRunning) { return GetProcessingStateResult<OfferHeaderModel>(); }
